...
use App\Http\Controllers\pengguna\PengetahuanController;
use App\Http\Controllers\pengguna\CreditController;
...
Route::group(['namespace' => 'pengguna', 'as' => 'pengguna.'], function () {
    ...
    Route::get('pengetahuan/{pengetahuan:slug}', [PengetahuanController::class, 'show'])->name('pengetahuan.show');

    Route::get('credit', [CreditController::class, 'index'])->name('credit.index');
    Route::get('credit/{credit:slug}', [creditController::class, 'show'])->name('credit.show');

    Route::resource('pesan', PesanController::class);
    Route::get('biodata', [BiodataController::class, 'index'])->name('biodata.index')->middleware('biodata');
    Route::post('biodata', [BiodataController::class, 'store'])->name('biodata.store');
    Route::get('biodata/reset', [BiodataController::class, 'reset'])->name('biodata.reset');
