                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cf" id="cf" class="form-control">
                                ...
                                <option value="1" {{$bp->cf == 1 ? 'selected' : null}}>Sangat Yakin</option>
                                <option value="0.8" {{$bp->cf == 0.8 ? 'selected' : null}}>Yakin</option>
                                <option value="0.6" {{$bp->cf == 0.6 ? 'selected' : null}}>Cukup Yakin</option>
                                <option value="0.4" {{$bp->cf == 0.4 ? 'selected' : null}}>Sedikit Yakin</option>
                                <option value="0.2" {{$bp->cf == 0.2 ? 'selected' : null}}>Tidak tahu</option>
                                <option value="0" {{$bp->cf == 0 ? 'selected' : null}}>Tidak</option>
                            </select>
                            @error('cf')
                                <div class="invalid-feedback">
                                    {{ $message }}
