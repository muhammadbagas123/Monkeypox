            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('admin.pengetahuan.create') }}" class="btn btn-primary"><i
                                ...
                                <tbody>
                                    @foreach ($pengetahuans as $pengetahuan)
                                        <tr>
                                            ...
                                            <td>{{ Str::title($pengetahuan->nama) }}</td>
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-md"
                                                    href="{{ route('admin.pengetahuan.show', $pengetahuan->id) }}"><i
        ...
        function hapusData(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    Swal.fire(
                        'Berhasil!',
                        'Data pengetahuan Berhasil Dihapus',
                        'success'
                    )
                    setTimeout(() => {
                        location.reload();
