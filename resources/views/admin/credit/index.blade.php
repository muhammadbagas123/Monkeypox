            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('admin.credit.create') }}" class="btn btn-primary"><i
                                ...
                                <tbody>
                                    @foreach ($credits as $credit)
                                        <tr>
                                            ...
                                            <td>{{ $credit->id }}</td>
                                            <td>{{ Str::title($credit->nama) }}</td>
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-md"
                                                    href="{{ route('admin.credit.show', $credit->id) }}"><i
