    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card card-primary">
                ...
                <form action="{{ route('admin.credit.update', $credit->id) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="nama">Nama credit</label>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror"" id=" nama"
                                name="nama" value="{{ $credit->nama }}" placeholder="Masukkan Nama Credit">
                            @error('nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="deskripsi"
                                class="form-control">{!! $credit->deskripsi !!}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="solusi" id="solusi" class="form-control">{!! $credit->solusi !!}</textarea>
                            @error('solusi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.credit.show', $credit->id) }}" class="btn btn-danger"><i
